angular.module('inventoryApp')
  .config(function ($stateProvider, $urlRouterProvider) {
    ...
    var newJobModalState = {
      ...
      templateUrl: './app/newJob/newJobTemplate.html',
      controller: 'newJobCtrl'
    };
    var landingState = {
      name: 'landing',
      url: '/landing',
      templateUrl: './app/landing/landingTmpl.html',
      controller: 'landingCtrl'
    };
    var workOrderState = {
      name: 'workOrders',
      url: '/workOrder',
      templateUrl: './app/workOrder/workOrderTmpl.html',
      controller: 'workOrderCtrl'
    };
    var completedWorkState = {
      name: 'completed',
      url: '/completedWork',
      templateUrl: './app/purchaseOrder/poTmpl.html',
      controller: 'poCtrl'
    };
